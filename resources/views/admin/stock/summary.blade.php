    ...
    <section class="content">
        <div class="panel" id="printableArea">
            <div class="box-header with-border">
                <h3 class="box-title">Stocks Summary</h3>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-8 text-right">
                                            <form method="GET" action="{{ route('admin.stocks.location.summary') }}" class="form-inline">
                                                ...
                                                <a href="{{ route('admin.stocks.location.summary') }}" class="btn btn-warning mb-2"><i class="fa fa-times"></i></a>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tr>
                                                                    <td colspan="2" class="service-block__service">
                                                                        <strong class="service-block__category-title"><a href="{{ route('admin.stocks.category', $category->id) }}">{{ $category->category_name }}</a></strong>
                                                                    ...
                                                                    @php
                                                                        ...
                                                                        foreach($category->nested()->orderBy('id', 'ASC')->get() as $key1 => $childCat)
                                                                            $sum_tot_Price += $childCat->stocks->where('location', 'hq')->sum('qty')
                                                                    @endphp
                                                                            ...
                                                                            <table class="table">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="service-block__service">
                                                                                        <strong
                                                                                            class="service-block__category-title"><a href="{{ route('admin.stocks.category', $childCat->id) }}?location=hq">{{ $childCat->category_name }}</a></strong>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    @php
                                                                        ...
                                                                        foreach($category->nested()->orderBy('id', 'ASC')->get() as $childCat)
                                                                            $sum_tot_Price += $childCat->stocks->where('location', 'gs1')->sum('qty')
                                                                    @endphp
                                                                    <td class="service-block__action"> {{ $sum_tot_Price}}</td>
                                                                </tr>
                                                                </thead>
                                                                    ...
                                                                    <tr class="child child_cat1_{{ $category->id }} child-sort-row"
                                                                        ...
                                                                        <td colspan="3"
                                                                            ...
                                                                            <table class="table">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="service-block__service">
                                                                                        <strong class="service-block__category-title"><a href="{{ route('admin.stocks.category', $childCat->id) }}?location=gs1">{{ $childCat->category_name }}</a></strong>
                                                                                        @if($childCat->nested->count())
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    @php
                                                                        $sum_tot_Price = 0;
                                                                        foreach($category->nested()->orderBy('id', 'ASC')->get() as $childCat)
                                                                            $sum_tot_Price += $childCat->stocks->where('location', 'gs2')->sum('qty')
                                                                    @endphp
                                                                    <td class="service-block__action"> {{ $sum_tot_Price}}</td>
                                                                </tr>
                                                                </thead>
                                                                    ...
                                                                    <tr class="child child_cat2_{{ $category->id }} child-sort-row" data-id="{{ $childCat->id }}">
                                                                        ...
                                                                        <td colspan="3"
                                                                            ...
                                                                            <table class="table">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="service-block__service">
                                                                                        <strong class="service-block__category-title"><a href="{{ route('admin.stocks.category', $childCat->id) }}?location=gs2">{{ $childCat->category_name }}</a></strong>
                                                                                        @if($childCat->nested->count())
