        ...
        <div class="panel" id="printableArea">
            <div class="box-header with-border">
                ...
                <div class="box-tools pull-right">
                    ...
                    <a href="{{ route('admin.stocks.index') }}" class="btn btn-info pull-right"><i class="fa fa-angle-double-up"></i> List of Stocks</a>
                </div>
            </div> <!-- /.box-header -->
                       ...
                       <div class="panel-body">
                           <table class="table table-hover table-2nd-no-sort">
                               ...
                               @foreach($categories_head as $category)
                                   <tr>
                                       <td><a href="{{ route('admin.stocks.category', $category->id) }}">{{ $category->category_name }}</a></td>
                                       <td>{{ $category->stocks->sum('qty') }}</td>
                                   </tr>
                               @endforeach
                               </tbody>
                           </table>
