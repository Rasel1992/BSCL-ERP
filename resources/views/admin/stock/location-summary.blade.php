    ...
    <section class="content">
        <div class="panel" id="printableArea">
            <div class="box-header with-border">
                <h3 class="box-title">@if($location == 'hq') Head Quarter @elseif($location == 'gs1') GS Gazipur @else GS Betbhunia @endif Stocks Summary</h3>
                <div class="box-tools pull-right">
                    <a href="javascript:void(0)" class="btn btn-success pull-left" onclick="printDiv('printableArea')">Print</a>&nbsp;&nbsp;
                    <a href="{{ route('admin.stocks.summary') }}" class="btn btn-info pull-right"><i class="fa fa-angle-double-up"></i> List of Back</a>
                </div>
            </div> <!-- /.box-header -->
            <div class="row">
                <div class="col-xs-12">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    @php
                                                                        ...
                                                                        foreach($category->nested()->orderBy('id', 'ASC')->get() as $key1 => $childCat)
                                                                            $sum_tot_Price += $childCat->stocks->where('location', $location)->sum('qty')
                                                                    @endphp
                                                                        ...
                                                                        <td colspan="3"
                                                                            ...
                                                                            <table class="table">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="service-block__action text-center">{{ $childCat->stocks->where('location', $location)->sum('qty') }}</td>
                                                                                </tr>
                                                                                </thead>
                                                                                <tbody>
                                                                                @foreach($childCat->nested()->orderBy('id', 'ASC')->get() as $key2 => $grandChildCat)
                                                                                    <tr class="child child_cat_{{ $childCat->id }} grand-child-sort-row"
                                                                                        ...
                                                                                        <td class="service-block__action text-center">{{ $grandChildCat->stocks->where('location', $location)->sum('qty') }}</td>
                                                                                    </tr>
                                                                                @endforeach
                                                                                </tbody>
                                                                            </table>
