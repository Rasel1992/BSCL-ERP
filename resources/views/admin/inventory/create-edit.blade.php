...
@section('title')
    @if(isset($stock)) Edit @else Create @endif | Inventory
@endsection
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group @error('asset_code ') has-error @enderror">
                                        ...
                                        <input class="form-control" placeholder="Asset Code" name="asset_code" value="{{old('asset_code ')}}" type="text" required>
                                        @error('asset_code ')
                            ...
                            <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group @error('description') has-error @enderror">
                                        ...
                                        <input class="form-control" placeholder="Description" name="description" value="{{old('description')}}" type="text">
                                        @error('description')
                                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group @error('voucher_no') has-error @enderror">
                                        ...
                                        <input class="form-control" placeholder="Voucher No" name="voucher_no" value="{{old('voucher_no')}}" type="text">
                                        @error('voucher_no')
                                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group @error('purchase_date') has-error @enderror">
                                        ...
                                        <input class="form-control" placeholder="Purchase Date" name="purchase_date" value="{{old('purchase_date')}}" type="date" required>
                                        @error('purchase_date')
                                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group @error('qty') has-error @enderror">
                                        ...
                                        <input class="form-control" placeholder="Qty" name="qty" value="{{old('qty')}}" type="number">
                                        @error('qty')
                                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group @error('cost') has-error @enderror">
                                        ...
                                        <input class="form-control" placeholder="Cost" name="cost" value="{{old('cost')}}" type="number" id="cost">
                                        @error('cost')
                                        <span class="help-block">
                            <strong>{{ $message }}</strong>
                        </span>
