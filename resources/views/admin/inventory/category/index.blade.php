        ...
        <div class="panel" id="printableArea">
            ...
            <div class="panel-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <form method="GET" action="{{ route('admin.inventory-category.index') }}" class="form-inline float-right">
                            ...
                            <a href="{{ route('admin.inventory-category.index') }}" class="btn btn-warning mb-2"><i class="fa fa-times"></i></a>
                        </form>
                    </div>
                </div>
                <br>
